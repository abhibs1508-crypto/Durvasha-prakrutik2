...
import { LayoutGroupContext, PresenceContext, SwitchLayoutGroupContext, addScaleCorrector, alpha, buildHTMLStyles, buildSVGAttrs, camelToDash, clamp, degrees, featureDefinitions, formatErrorMessage, invariant, isAnimationControls, isBrowser, isCSSVariableName, isCSSVariableToken, isControllingVariants, isMotionValue, isRefObject, isSVGComponent, isSVGTag, isVariantLabel, isVariantNode, number, numberValueTypes, optimizedAppearDataAttribute, percent, px, resolveMotionValue, resolveVariantFromProps, scaleCorrectors, scrapeMotionValuesFromProps, scrapeMotionValuesFromProps$1, transformPropOrder, transformProps, variantPriorityOrder, variantProps, vh, vw, warning } from "./motion-XsHMhX4g.js";
...
function hasScale({ scale, scaleX: scaleX$1, scaleY: scaleY$1 }) {
	return !isIdentityScale(scale) || !isIdentityScale(scaleX$1) || !isIdentityScale(scaleY$1);
}
...
//#endregion
export { AsyncMotionValueAnimation, DOMKeyframesResolver, HTMLVisualElement, JSAnimation, KeyframeResolver, MotionGlobalConfig, MotionValue, NativeAnimation, NativeAnimationExtended, SVGVisualElement, SubscriptionManager, VisualElement, activeAnimations, addDomEvent, addPointerEvent, addPointerInfo, addUniqueItem, analyseComplexValue, animateSingleValue, animateTarget, animateValue, animateVisualElement, animations, anticipate, applyGeneratorOptions, backIn, backInOut, backOut, calcGeneratorDuration, calcLength, cancelFrame, cancelMicrotask, circIn, circInOut, circOut, collectMotionValues, color, complex, convertOffsetToTimes, createBox, createDomVisualElement, createGeneratorEasing, createRenderBatcher, cubicBezier, cubicBezierAsString, defaultEasing, defaultOffset, defaultTransformValue, defaultValueTypes, delay, dimensionValueTypes, distance, distance2D, drag, easeIn, easeInOut, easeOut, easingDefinitionToFunction, featureBundle, fillOffset, fillWildcards, findDimensionValueType, findValueType, flushKeyframeResolvers, frame, frameData, frameSteps, generateLinearEasing, gestureAnimations, getAnimatableNone, getDefaultValueType, getMixer, getOptimisedAppearId, getValueTransition, getVariableValue, hasReducedMotionListener, hasWarned, hex, hover, hsla, hslaToRgba, inertia, initPrefersReducedMotion, interpolate, invisibleValues, isBezierDefinition, isCSSVar, isDragActive, isDragging, isEasingArray, isGenerator, isHTMLElement, isNodeOrChild, isNumericalString, isObject, isPrimaryPointer, isSVGElement, isSVGSVGElement, isZeroValueString, keyframes, layout, makeAnimationInstant, mapEasingToNativeEasing, maxGeneratorDuration, memo, microtask, millisecondsToSeconds, mirrorEasing, mix, mixArray, mixColor, mixComplex, mixImmediate, mixLinearColor, mixNumber, mixObject, mixVisibility, motionValue, moveItem, noop, parseCSSVariable, parseValueFromTransform, pipe, positionalKeys, prefersReducedMotion, press, progress, readTransformValue, removeItem, resolveElements, reverseEasing, rgbUnit, rgba, rootProjectionNode, secondsToMilliseconds, setDragLock, setStyle, setTarget, spring, startWaapiAnimation, statsBuffer, stepsOrder, supportedWaapiEasing, supportsBrowserAnimation, supportsFlags, supportsLinearEasing, supportsScrollTimeline, testValueType, time, useIsPresent, usePresence, velocityPerSecond, visualElementStore, warnOnce };
//# sourceMappingURL=feature-bundle-DJtz9xy1.js.map